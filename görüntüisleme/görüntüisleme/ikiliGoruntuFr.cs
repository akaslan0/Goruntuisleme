...
{
    public partial class ikiliGoruntuFr : Form
    {
        Bitmap kaynak,kaynak2, islem;
        public ikiliGoruntuFr()
        {
            InitializeComponent();
        }
        ...
        private void KaynakBox1_Click(object sender, EventArgs e)
        {
